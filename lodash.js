...
// Bonus Points
const totalByMonth = _.reduce(purchasesByMonth, (sum, elem, key) => {
  return sum + elem[]

}, 0)

console.log(totalByMonth);// Use the grouped purchasesByMonth and reduce to create a totalByMonth object.
